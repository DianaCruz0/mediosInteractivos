...
function draw() {
  background(Fondo, windowWidth,windowHeight);
  text("Desliza y oprime el mouse para sembrar plantas", 30, windowHeight-50);
  text("Mueve el dispositivo para atrapar a los ratónes con el Halcón", 30, 40);
