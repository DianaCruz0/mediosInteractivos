...
function draw() {
  ...
  if (estado == INTRO) {
    ...
    text("NIVEL 3: Habrá más depredadores,desaparecelos a todos, ganarás cuando tengas 30 puntos",windowHeight/2-70, windowWidth/2+60);
    ...
    textAlign(CENTER);
    fill(255);
    text("Ahora hay más depredadores,desaparecelos a todos", 250,40);
    ...
    textAlign(CENTER);
    textSize(20);
    text("Pero puedes volver a jugar :) ", width / 2, height / 2 + 60);
  }
}
